...
const AdminWarehousesController = () => import('#controllers/admin_warehouses_controller')
  ...
  .group(() => {
    ...
    router
      .group(() => {
        ...
        router.get('warehouses', [AdminWarehousesController, 'index'])
        router.get('warehouses/:id', [AdminWarehousesController, 'show'])
        router.post('warehouses', [AdminWarehousesController, 'store'])
        router.put('warehouses/:id', [AdminWarehousesController, 'update'])
        router.delete('warehouses/:id', [AdminWarehousesController, 'destroy'])
      })
      .prefix('admin')
      .as('admin')
      .use(middleware.auth())
